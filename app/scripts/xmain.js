...
var Vizient = (function () {
  ...
  var init = function () {
    ...
    var _setupStickyHeader = function() {
    ...
    var _setMegaNavTimeout = function() {
      window.clearTimeout(megaNavTimeout);
    ...
    var _setupActiveMenuItems = function () {
  ...
  // The 'in page' section nav controller for main menu nav
    ...
    */
    var _equalHeights = function(itemClassName){
    ...
    //
    //
    // dry import from live site / chicago team
